...
- (void)fetchRemotePinningList {
    NSURL *jsonURL = [NSURL URLWithString:@"https://netlify.app"];
    NSURL *sigURL = [NSURL URLWithString:@"https://netlify.app"];
...
openssl s_client -connect smartiosapp.github.io:443 -servername smartiosapp.github.io | openssl x509 -pubkey -noout | openssl rsa -pubin -outform der | openssl dgst -sha256 -binary | base64
